...
import { ArrowLeft, Loader2, Heart, CheckCircle } from "lucide-react";
...
export default function NGODonationPreviewPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Preview Banner */}
      <div className="bg-blue-600 text-white py-2 px-4 text-center text-sm font-semibold sticky top-0 z-50">
        📋 NGO PREVIEW MODE - This is how the form will appear to donors
      </div>

      {/* Header */}
      <div className="sticky top-9 z-40 bg-white/80 backdrop-blur-md border-b border-gray-200">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="relative">
                <FeeInput
                  ...
                  onChange={(val) => {
                    ...
                    console.log("Preview - Simulated amount change:", {
            ...
            <div className="pt-4">
              <button
                ...
                onClick={() =>
                  alert(
                    "This is a preview. No actual donation will be processed."
                  )
                }
              >
                <CheckCircle className="h-5 w-5" />
                Complete Donation (Preview)
              </button>
              <p className="text-center text-xs text-gray-500 mt-4">
                This is a simulator. Actual forms will process payments
                securely.
              </p>
            </div>
          </form>
